...
import Login from "../../../pages/Login/Login"; // your existing login UI
import Register from "../../../pages/Register/Register"; // optional, kept for future
          ...
          "
            ...
            "
                    >
                        ...
                        {/* Not logged in → show Login.jsx */}
                        {!user ? (
                            <Login
                                onLoginSuccess={(loggedUser) => {
                                    setUser(loggedUser);   // { name, image }
